...
Vec3f trace(const Vec3f &rayorig, const Vec3f &raydir, const vector<Sphere *> &spheres, const int &depth, Sphere* my_sphere)
{
	...
	if (sphere != NULL) {
		...
		Vec3f phit = rayorig + raydir * tnear; // 交点
...
int main(int argc, char **argv)
{
	...
	spheres.push_back(new Sphere(Vec3f(-2, -2, -25), 1, Vec3f(0.1, 0.1, 1.0), 0.15, 0));
	spheres.push_back(new Sphere(Vec3f(5, 5, -25), 2, Vec3f(0.1, 1.0, 0.1), 0.2, 0));
